<script type="text/javascript">
    ...
    $(function () {
        ...
        $('.create-quote').click(function () {
            ...
            $('#modal-placeholder').load('#quotes.create');
        });

        $('.create-invoice').click(function () {
            clientName = $(this).data('unique-name');
            $('#modal-placeholder').load('#invoices.create');
        });

        $('.create-recurring-invoice').click(function () {
            clientName = $(this).data('unique-name');
            $('#modal-placeholder').load('#recurringInvoices.create');
        });

        $(document).on('click', '.email-quote', function () {
            $('#modal-placeholder').load('#quoteMail.create', {
        ...
        $(document).on('click', '.email-invoice', function () {
            $('#modal-placeholder').load('#invoiceMail.create', {
        ...
        $(document).on('click', '.enter-payment', function () {
            $('#modal-placeholder').load('#payments.create', {
                invoice_id: $(this).data('invoice-id'),
